...
| Section                                        | Description                            |
| ---------------------------------------------- | -------------------------------------- |
| [Knowledge Knook]                              | 📚 Overview of Knowledge Knook goals   |
...
<br/>
☝ Knowledge Knook edu-tech platform and  consists of three main components:  <br/>
...
The Knowledge Knook platform's API is designed following the REST architectural style. The
